...
import { VILLAINS } from './villains.js';     // urban-villain register (armored authority, tactical kit) — elite / boss reuse
import { MECHS } from './mechs.js';           // sci-fi bipedal walkers + alien hunters — elite / boss reuse
import { MYTHIC } from './mythic.js';         // fantasy / mythic register (orc, minotaur, lich…) — elite / boss reuse
...
export const CHARACTERS = {
  ...
  // ── corporate / office-ecosystem pack: bespoke office-tower icons (Corporate Climb
  //    origin; reusable). executive · courier · janitor · barista · securityGuard ──
  ...OFFICE,

  // ── boss / elite roster (block-party + future games): each silhouette
  //    designed to read as "elite, NOT a regular grunt" at thumbnail.
  //    Reusable across games via the CHARACTERS aggregator. ──
  ...VILLAINS,   // urban: swat, …
  ...MECHS,      // sci-fi: combatMech, …
  ...MYTHIC,     // mythic: minotaur, …
};
